<template>
  ...
  >
    ...
    <div class="flex items-center h-16 px-4 border-b border-gray-100">
      ...
      <span v-if="!collapsed" class="ml-3 font-semibold truncate">Careflow</span>
    </div>
    ...
    <div class="px-2 pb-3">
      <button
        class="flex items-center justify-center w-full px-3 py-2 rounded-lg text-sm hover:bg-gray-100 transition-colors"
        @click="$emit('toggle')"
      >
        <UIcon
    ...
    <div class="px-3 py-3 border-t border-gray-100 space-y-2">
      ...
      <UIcon v-else name="i-lucide-user-circle" class="text-xl mx-auto block" />
